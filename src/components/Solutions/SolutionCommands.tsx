                    ...
                    <div className="pt-3 mt-3 border-t border-white/10">
                      ...
                      <div className="mb-3 px-2 space-y-1">
                        <div className="flex items-center justify-between text-[13px] font-medium text-white/90">
                          ...
                          <button
                            className="bg-white/10 hover:bg-white/20 px-2 py-1 rounded text-[11px] cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-[11px] text-red-400 hover:text-red-300 transition-colors w-full cursor-pointer"
                      >
